...
Desarrollador Full Stack | Especialista en JavaScript, TypeScript y Frameworks Modernos con experiencia en el desarrollo de aplicaciones web dinámicas y escalables, tanto en el frontend como en el backend. Experto en HTML, CSS y JavaScript, con sólidos conocimientos en frameworks como ReactJS, NextJS, Node.js y NestJS. Manejo avanzado de bases de datos relacionales y no relacionales (PostgreSQL, MySQL, MongoDB). Experiencia trabajando en entornos ágiles (Scrum). Estoy comprometido con la mejora continua, la optimización del rendimiento y la experiencia del usuario, y busco contribuir a proyectos innovadores que desafíen mis habilidades técnicas.

### 🛠️ Habilidades Técnicas

- **Lenguajes de Programación:** HTML, CSS, JavaScript, TypeScript
- **Frameworks y Librerías:** ReactJS, NextJS, PicoCSS (Front), NestJS, NodeJS, Express.js (Back)
- **Bases de Datos:** PostgreSQL, MySQL, MongoDB (Mongoose)
- **Gestión de Persistencia de Datos:** TypeORM, Mongoose
- **DevOps y Herramientas:** Docker, cPanel, Git, Jira, Slack, Miro, AWS, Azure
- **Autenticación y Seguridad:** JWT, Nodemailer (Envío de correos), WebSockets
- **Metodologías de Desarrollo:** Agile (Scrum), Pair Programming
- **Otros:** Optimización de imágenes en frontend, Generación de PDFs con html-pdf, Backup automático de bases de datos, Pruebas de usabilidad y UX

### 📫 Mas información

- **Email:** fgp555@gmail.com
- **LinkedIn:** [linkedin.com/in/fgp555](https://www.linkedin.com/in/fgp555/)
- **Porfolio:** [frankgp.com/portfolio](https://frankgp.com/portfolio/)
